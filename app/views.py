...
class SC2BarChartView(View):
    def get(self, request):
        cores_laboratorios = {"Hemoce": "#d62d20", "Unadig": "#0057e7", 
                              "Lacen": "#008744", "Argos": "#ffa700", "HAUW": "#673ab7"}
        ...
        cores_variantes = {"Outras": "#8b9dc3",
                           ...
                           "VOC Omicron (BA.1-like)": "#d896ff",
                           "VOC Omicron (BA.2-like)": "#be29ec",
                           "VOC Omicron (BA.4-like)": "#711c91",
                           "VOC Omicron (BA.5-like)": "#54295c",
                           "VOC Omicron (recombinante)": "#ff2a6d"}
